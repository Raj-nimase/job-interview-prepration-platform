...
const Footer = () => {
  return (
    <footer className="bg-emerald-600/70 text-white px-6 md:px-12 py-10">
      ...
      >
        ...
        >
          ...
          <div className="flex gap-4">
            <a href="#" className="bg-white/10 rounded-full p-2 text-2xl shadow-md transition-transform duration-200 hover:scale-110 hover:bg-blue-800 hover:text-blue-300">
              <FaLinkedinIn />
            </a>
            <a href="#" className="bg-white/10 rounded-full p-2 text-2xl shadow-md transition-transform duration-200 hover:scale-110 hover:bg-blue-800 hover:text-blue-300">
              <FaGithub />
      ...
      {/* Bottom Bar */}
      <motion.div
        className="border-t border-white mt-10 pt-5 flex flex-col md:flex-row items-center justify-between text-sm text-blue-200 gap-3"
        variants={item}
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
