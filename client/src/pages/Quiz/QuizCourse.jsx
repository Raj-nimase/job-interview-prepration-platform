          ...
          <div key={lvl.level} className="mb-16 relative">
            ...
            <div className="flex justify-center flex-wrap gap-6">
              {lvl.topics.map((topic) => (
                <div
                  ...
                  className={`relative cursor-pointer w-72 bg-gradient-to-br ${topic.color
                    } text-white rounded-2xl shadow-lg transform hover:scale-105 transition-transform duration-300 border-2 border-transparent ${idx + 1 > unlockedLevel
            ...
            {idx < levels.length - 1 && (
              <div className="flex justify-center mt-6">
                <div className="h-1 w-2/3 bg-gray-300 dark:bg-white rounded-full opacity-20"></div>
              </div>
            )}
          </div>
        ))}
        ...
        >
          ...
          <div className="fixed inset-0 flex items-center justify-center p-4">
            <Dialog.Panel className="bg-white text-black rounded-xl shadow-xl p-6 w-full max-w-md border dark:border-gray-700">
              ...
              <p>
                Are you ready to begin the <strong>{modalTopic}</strong>{" "}
                quiz?
              </p>
